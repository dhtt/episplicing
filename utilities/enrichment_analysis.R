...
bootcor_fisher_res_list = readRDS("all_res_con/tissue_spec/all_res_list.bootcor_fisher_sig_joined_genes.RDS")
...
all_res.mf = list(pearcor_res.mf, spearcor_res.mf, pearcor_p_res.mf, spearcor_p_res.mf, chisq_res.mf)
...
all_res.bp = list(pearcor_res.bp, spearcor_res.bp, pearcor_p_res.bp, spearcor_p_res.bp, chisq_res.bp)
